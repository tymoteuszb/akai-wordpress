<?php
/*
Plugin Name: AKAI WPSSO
Plugin URI: http://akai.org.pl
Description: Addition to WPSSO plugin, so a horizontal photo of a post will be the main photo in OG tags. Note: It must be loaded before the WPSSO plugin.
Version: 1.3.6
Author: Jacek Tomaszewski
Author URI: http://jtom.me
Author Email: jacek@jtom.me
*/
 ...
 *
 */
// The source of this class is the same as in wpsso plugin, beside the get_options() method.
// For changes, look for the 'AKAI addition' comment.
class WpssoPostmeta {
  ...
  public function get_options( $post_id, $idx = '' ) {
    // AKAI addition START
    if ($idx == 'og_img_url' && ($horizontal_photo = get_field('horizontal_photo'))) {
